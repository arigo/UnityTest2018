...
namespace BaroqueUI
{
    ...
    public interface IGlobalControllerTracker
    {
        ...
        event ControllerEvent onMenuClick;          /* or, for B button on Oculus */

        event ControllerEvent onTouchPressDown;     /* or, for A button on Oculus */
        event ControllerEvent onTouchPressDrag;
        event ControllerEvent onTouchPressUp;
        event ControllerVec2Event onTouchScroll;    /* the remaining four         */
        event ControllerEvent onTouchDown;          /*   onTouchXxx event         */
        event ControllerEvent onTouchDrag;          /*     are never called       */
        event ControllerEvent onTouchUp;            /*       on Oculus            */
    }
    ...
    public class ControllerTracker: IControllerTracker
    {
        ...
        internal ControllerEvent _i_onMenuClick;        /* or, for B button on Oculus */
        internal ControllerEvent _i_onTouchPressDown;   /* or, for A button on Oculus */
