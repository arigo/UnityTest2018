...
namespace BaroqueUI
{
    ...
    public class Controller : MonoBehaviour
    {
        ...
        public static Model controllerModel { get { return controller_model; } }
        public static bool haveRealTouchpad { get {
                return controller_model == Model.HTCVive || controller_model == Model.Other;  // maybe?
            } }
        public static bool haveJoystick { get { return controller_model == Model.OculusTouch; } }
        ...
        BaroqueVRManager baroque_vr_manager;
        ...
        internal void _Initialize(BaroqueVRManager mgr, int index)
        {
            baroque_vr_manager = mgr;
            controller_index = index;
            controller_model = mgr.controller_model;
            controllerState = mgr.NewControllerState(this);
            ...
            switch (controller_model)
            {
                ...
                default:
                    hotspot.localPosition = new Vector3(0, -0.006f, 0.056f);   /* default */
                    break;
            }
        ...
        void UpdateScrollWheel()
        {
            switch (controllerModel)
            {
                ...
                case Model.OculusTouch:
                    Color color = (scrollWheelVisible != 0 ? new Color(0.12f, 0.46f, 0.2f) : Color.black);
                    SetComponentColor(EColorizableComponent.Joystick, color);
                    break;
            }
        }
