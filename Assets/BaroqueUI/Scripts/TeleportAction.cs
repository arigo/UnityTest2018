/* This script is disabled, maybe temporarily.  Re-enable by copying some of the logic from
 * either SteamVR (for the Resources/BaroqueUI/Teleporting prefab), or from VRSketch4 (which
 * uses its own custom version instead). */
#if false
using System;
...
namespace BaroqueUI
{
    public class TeleportAction : MonoBehaviour
    {
        ...
        void Start()
        {
            arc = gameObject.AddComponent<TeleportArc>();
